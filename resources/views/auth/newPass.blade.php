...
<head>
    ...
    <title>Fluid - Redefinir Senha</title>
...
<div id="page-container">
    ...
    <main id="main-container">
        <!-- Page Content -->
        <div class="row g-0 justify-content-center bg-body-extra-dark">
            <div class="hero-static col-sm-10 col-md-8 col-xl-6 d-flex align-items-center p-2 px-sm-0">
                <!-- Reminder Block -->
                <div class="block block-rounded block-transparent block-fx-pop w-100 mb-0 overflow-hidden bg-image" style="background-image: url({{ asset('assets/media/various/login-bg.jpg') }});">
                    <div class="row g-0">
                        <div class="col-md-6 order-md-1 bg-body-extra-light">
                            <div class="block-content block-content-full px-lg-5 py-md-5 py-lg-6">
                                ...
                                <div class="mb-2 text-center">
                                    ...
                                    <p class="text-uppercase fw-bold fs-sm text-muted">Redefinir Senha</p>
                                </div>
                                <!-- END Header -->
                                ...
                                <form class="js-validation-reminder" action="{{ route('user.redefinirSenha', $user->id) }}" method="POST">
                                    ...
                                    <div class="text-center mb-4">
                                        <button type="submit" class="btn w-100 btn-hero btn-primary">
                                            <i class="fa fa-fw fa-reply opacity-50 me-1"></i> Alterar
                                        </button>
                                    </div>
                                </form>
                                <!-- END Reminder Form -->
                        ...
                        <div class="col-md-6 order-md-0 bg-gd-fruit-op d-flex align-items-center">
                            <div class="block-content block-content-full px-lg-5 py-md-5 py-lg-6 text-center">
                                ...
                                <p class="fs-3 fw-semibold text-white-75 mb-0">
                                    O melhor gerenciador do seu dia a dia!
                                </p>
                            </div>
                        </div>
                    </div>
